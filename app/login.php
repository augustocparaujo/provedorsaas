...
<body class="hold-transition login-page">
  <div class="login-box" style="border: 1px solid red">
    ...
    <div class="login-box-body">
      ...
      <center>
        <h3 class="text-red">Acesso do cliente</h3>
      </center>

      <form class="login-form" id="form-login" method="post">
        <div class="form-group has-feedback">
          <input type="number" class="form-control" placeholder="Digite seu usuário" name="usuario" required />
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
          <input type="number" class="form-control" placeholder="Digite sua senha" name="senha" required />
          <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
        <div class="row">
          <div class="col-xs-12">
            <button type="submit" class="btn btn-primary btn-block btn-flat" id="aguarde"><i class="fa fa-sign-in"></i> ACESSAR</button>
          </div>
          <!-- /.col -->
        </div>
        <div class="row">
      ...
      <b>
        <center>© MK-Gestor v1.0.0 - Sistema de Gestão.</center>
      </b>
    </div>
    <!-- /.login-box-body -->
  </div>
