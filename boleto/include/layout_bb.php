...
<div id="container">
	...
	<center><img src="../logocli/<?php echo $ret['logomarca']; ?>" width="10%"/></center>	
	<div>
		<table style="align-items:center; text-align:center; margin: 5px">
			<tr style="background:#dcdc; ">	
				...
				<td style="font-size: 14px; font-weight:bold">
					Valor<br />
					<?php echo 'R$ '.Real($ret["valor"]); ?>
				</td>
			</tr>
			<tr>
				<td style=" width: 200px; text-align:left !important">
				<p>Beneficiário</p>
				<p><?php echo $dadosboleto['cedente']; ?> <br/> <?php echo 'CNPJ: '.$dadosboleto["cpf_cnpj"]; ?></p><br />
				

					<p>Código de pagamento Pix Copia e Cola:</p>
					<p><?php echo $ret['installmentLink']; ?></p>

				</td>
				<td style="width:100%">
					<p>QR code</p>
					<img src="../imgqrcode/<?php echo $dadosboleto['numero_documento']; ?>.png" width="40%"/>
				</td>
			</tr>
		</table>
	</div>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD class=ct width=666><div align=right><b class=cp>Recibo do Sacado</b></div></TD></tr></tbody></table>
		...
		<tr class="campos">
			<td class="num_doc"><?php echo $ret["code"]?></td>
			...
			<td class="valor_doc"><?php echo Real($ret["valor"]); ?></td>
		</tr>
      </tbody>
      </table>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD width=666 align=right ><font style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensação</font></TD></tr></tbody></table>
		<div class="barcode">
			<p><?php fbarcode($ret["codigobarra"]); ?></p>
		</div>
		<div class="cut">
			<p>Corte na linha pontilhada</p>
		</div>
